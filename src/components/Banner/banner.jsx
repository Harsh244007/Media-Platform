...
const Banner = () => {
  ...
  return (
    <Carousel className={styles.carousel} navButtonsAlwaysVisible="true" animation="fade" duration="5000" NextIcon={<NavigateNextOutlinedIcon />} PrevIcon={<NavigateBeforeOutlinedIcon />}>
